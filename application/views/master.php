		...
		<div id="wrapper" class="container">
			...
			<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<img src="<?php echo base_url(); ?>front_end/themes/images/carousel/banner-1.jpg" alt="" />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>front_end/themes/images/carousel/banner-2.jpg" alt="" />
							<div class="intro">
			...
			<section class="our_client">
				...
				<div class="row">					
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/14.png"></a>
					</div>
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/35.png"></a>
					</div>
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/1.png"></a>
					</div>
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/2.png"></a>
					</div>
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/3.png"></a>
					</div>
					<div class="span2">
						<a href="#"><img alt="" src="<?php echo base_url(); ?>front_end/themes/images/clients/4.png"></a>
					</div>
				</div>
			</section>
